...
import 'package:app_w_gestorcontable/widgets/recent_transactions.dart';
            ...
            ElevatedButton(
                ...
                child: const Padding(
                  ...
                  child: Text(
                    'Recent transaction',
                    style: TextStyle(
                        color: WeinFluColors.brandLightDarkColor, fontSize: 14),
                  ),
                )),
          ],
        ));
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      RecentTransactionCard(
        typeRecentTransaction: TypeRecentTransaction.incomes, 
        description: "Registro de movimiento",
        amount: 999999, 
        date: "28 de julio de 2024"),
        RecentTransactionCard(
        typeRecentTransaction: TypeRecentTransaction.spending, 
        description: "Registro de movimiento",
        amount: 999999, 
        date: "28 de julio de 2024"),    
    ]
